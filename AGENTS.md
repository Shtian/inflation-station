...
- Transactions API convention: keep pagination/filter query logic in `src/lib/transactions/*` and keep `/api/transactions` focused on query-param validation plus HTTP error mapping.
