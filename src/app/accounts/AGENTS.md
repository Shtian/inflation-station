...
- Use shared `Field` primitives (`Field`, `FieldLabel`, `FieldContent`) for account form controls while preserving existing control ids/placeholders for accessibility and E2E selectors.
